...
## Implement 3
```{r,echo=TRUE}
lmresid <- tibble(lmresid = resid(aov(maxt~yday(date),wmean)))
...
(p <- ggpredict(meanO,terms = c("meanmaxtempO","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
...
(p <- ggpredict(meanI,terms = c("meanmaxtempI","habitat","Species")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
...
(p <- ggpredict(meanI,terms = c("meanmaxtempI","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Maximum temperature (z-scaled)") +
    ylab("Nestling growth (z-scaled)") +
    labs(title = element_blank(),color = "Cover type") +
...
(p <- ggpredict(meanI_WEBL,terms = c("meanmaxtempI","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
...
(p <- ggpredict(meanO_TRES,terms = c("meanmaxtempO","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
...
(p <- ggpredict(meanI_TRES,terms = c("meanmaxtempI","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly mean maximum internal temperature") +
    ylab("Predicted weekly TRES nestling growth") +
    labs(title = element_blank(),color = "Cover type") +
...
(p <- ggpredict(meanO_canopy,terms = c("meanmaxtempO","canopy_cover","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly mean maximum external temperature") +
...
(p <- ggpredict(meanO_canopy_nohabitat,terms = c("meanmaxtempO","canopy_cover")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly mean maximum external temperature") +
    ylab("Predicted weekly nestling growth (TRES and WEBL)") +
    labs(title = element_blank(),color = "% Canopy cover") +
...
(p <- ggpredict(canopyxhabitat,terms = c("canopy_cover","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Canopy cover") +
    ylab("Predicted weekly nestling growth (TRES and WEBL)") +
    labs(title = element_blank(),color = "Cover type") +
...
```
```{r,echo=TRUE}
(p <- ggpredict(over40O_canopy,terms = c("cumulativeover40O","canopy_cover","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
...
(p <- ggpredict(over40O_canopy,terms = c("cumulativeover40O","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly cumulative external temperature over 40C") +
    ylab("Predicted weekly nestling growth (TRES and WEBL)") +
    labs(title = element_blank(),color = "Cover type") +
...
### Inside loggers
```{r,echo=TRUE}
(p <- ggpredict(over40I,terms = c("cumulativeover40I","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
...
(p <- ggpredict(over40I_canopy,terms = c("cumulativeover40I","canopy_cover","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly cumulative internal temperature over 40C") +
    ylab("Predicted weekly nestling growth (TRES and WEBL)") +
    labs(title = element_blank(),color = "% Canopy cover") +
...
```
```{r,echo=TRUE}
(p <- ggpredict(over40I_WEBL,terms = c("cumulativeover40I","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly cumulative internal temperature over 40C") +
    ylab("Predicted weekly WEBL nestling growth") +
    labs(title = element_blank(),color = "Cover type") +
...
```
```{r,echo=TRUE}
(p <- ggpredict(over40O_WEBL,terms = c("cumulativeover40O","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly cumulative external temperature over 40C") +
    ylab("Predicted weekly WEBL nestling growth") +
    labs(title = element_blank(),color = "Cover type") +
...
```
```{r,echo=TRUE}
(p <- ggpredict(over40I_TRES,terms = c("cumulativeover40I","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly cumulative internal temperature over 40C") +
    ylab("Predicted weekly TRES nestling growth") +
    labs(title = element_blank(),color = "Cover type") +
...
```
```{r,echo=TRUE}
(p <- ggpredict(over40O_TRES,terms = c("cumulativeover40O","habitat")) %>% plot(                                                                         alpha = .2) + 
  theme_classic() +
    xlab("Weekly cumulative external temperature over 40C") +
    ylab("Predicted weekly TRES nestling growth") +
    labs(title = element_blank(),color = "Cover type") +
