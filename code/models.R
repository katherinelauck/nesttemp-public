...
samp_year_webl <- g_lintemp@frame |>
  ...
  rowwise() |>
  mutate(
    `2021` = paste0(`2021`$count_ind, ", ", `2021`$count_attempt),
...
(t <- emmeans(g_lintemp, specs = ~habitat, by = c("meanmintempI_scaled"), at = list(meanmintempI_scaled = c(-2, 0, 2)), type = "response") |> as.tibble() |>
  mutate(
    meanmintempI_scaled = (meanmintempI_scaled * sd(data$meanmintempI)) + mean(data$meanmintempI),
...
samp_year_maxhiweek_webl <- g_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_maxhiweek_webl <- trans_new("temp_trans_maxhiweek_webl",
  transform = function(x) {
    (x * sd_temp_maxhiweek_webl) + mean_temp_maxhiweek_webl
  },
  inverse = function(x) {
    x
  }
...
(fig2_maxhiweek_webl <- predict_response(g_lintemp, terms = c("maxhi_week_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_maxhiweek_webl,
    breaks = c(
      (20 - mean_temp_maxhiweek_webl) / sd_temp_maxhiweek_webl,
...
samp_year_maxhiday_webl <- g_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_maxhiday_webl <- trans_new("temp_trans_maxhiday_webl",
  transform = function(x) {
    (x * sd_temp_maxhiday_webl) + mean_temp_maxhiday_webl
  },
  inverse = function(x) {
    x
  }
...
(fig2_maxhiday_webl <- predict_response(g_lintemp, terms = c("maxhi_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_maxhiday_webl,
    breaks = c(
      (20 - mean_temp_maxhiday_webl) / sd_temp_maxhiday_webl,
...
samp_year_deghr30week_webl <- g_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_deghr30week_webl <- trans_new("temp_trans_deghr30week_webl",
  transform = function(x) {
    (x * sd_temp_deghr30week_webl) + mean_temp_deghr30week_webl
  },
  inverse = function(x) {
    x
  }
...
(fig2_deghr30week_webl <- predict_response(g_lintemp, terms = c("degreehours_over_30C_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_deghr30week_webl,
    breaks = c(
      (0 - mean_temp_deghr30week_webl) / sd_temp_deghr30week_webl,
...
samp_year_hihr25week_webl <- g_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_hihr25week_webl <- trans_new("temp_trans_hihr25week_webl",
  transform = function(x) {
    (x * sd_temp_hihr25week_webl) + mean_temp_hihr25week_webl
  },
  inverse = function(x) {
    x
  }
...
(fig2_hihr25week_webl <- predict_response(g_lintemp, terms = c("hihours_over_30hi_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_hihr25week_webl,
    breaks = c(
      (0 - mean_temp_hihr25week_webl) / sd_temp_hihr25week_webl,
...
samp_year_maxhiweek_tres <- g_lintemp_addmin@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_maxhiweek_tres <- trans_new("temp_trans_maxhiweek_tres",
  transform = function(x) {
    (x * sd_temp_maxhiweek_tres) + mean_temp_maxhiweek_tres
  },
  inverse = function(x) {
    x
  }
...
(fig2_maxhiweek_tres <- predict_response(g_lintemp_addmin, terms = c("maxhi_week_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_maxhiweek_tres,
    breaks = c(
      (20 - mean_temp_maxhiweek_tres) / sd_temp_maxhiweek_tres,
...
samp_year_maxhiday_tres <- g_lintemp_addmin@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_maxhiday_tres <- trans_new("temp_trans_maxhiday_tres",
  transform = function(x) {
    (x * sd_temp_maxhiday_tres) + mean_temp_maxhiday_tres
  },
  inverse = function(x) {
    x
  }
...
(fig2_maxhiday_tres <- predict_response(g_lintemp_addmin, terms = c("maxhi_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_maxhiday_tres,
    breaks = c(
      (20 - mean_temp_maxhiday_tres) / sd_temp_maxhiday_tres,
...
samp_year_deghr30week_tres <- g_lintemp_addmin@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_deghr30week_tres <- trans_new("temp_trans_deghr30week_tres",
  transform = function(x) {
    (x * sd_temp_deghr30week_tres) + mean_temp_deghr30week_tres
  },
  inverse = function(x) {
    x
  }
...
(fig2_deghr30week_tres <- predict_response(g_lintemp_addmin, terms = c("degreehours_over_30C_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_deghr30week_tres,
    breaks = c(
      (0 - mean_temp_deghr30week_tres) / sd_temp_deghr30week_tres,
...
samp_year_hihr25week_tres <- g_lintemp_addmin@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_hihr25week_tres <- trans_new("temp_trans_hihr25week_tres",
  transform = function(x) {
    (x * sd_temp_hihr25week_tres) + mean_temp_hihr25week_tres
  },
  inverse = function(x) {
    x
  }
...
(fig2_hihr25week_tres <- predict_response(g_lintemp_addmin, terms = c("hihours_over_30hi_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_hihr25week_tres,
    breaks = c(
      (0 - mean_temp_hihr25week_tres) / sd_temp_hihr25week_tres,
...
g_lintemp <- lmerTest::lmer(gweight ~ meanmaxtempI_scaled * habitat + meanmintempI_scaled * habitat + age_scaled + juliandate_scaled + year_fct + (1 | attempt_id), data = dplyr::filter(dat_growth, Species == "TRES", !is.na(meanmaxtempI), meanmaxtempI < 45, !is.na(meanmintempI)) |>
  mutate(
    across(c(gweight, meanmaxtempI, meanmintempI, juliandate, brood_size, age),
      ~ scale(.x)[, 1],
      .names = "{.col}_scaled"
    ),
...
c1 <- anova(g_lintemp, g_lintemp_addmin, g_lintemp_noint) |>
  tibble() |>
  mutate(Model = c("no interaction", "single interaction", "both interacting"), .before = npar)

c2 <- anova(g_lintemp, g_lintemp_addmax, g_lintemp_noint) |>
  tibble() |>
  mutate(Model = c("no interaction", "single interaction", "both interacting"), .before = npar)
...
data <- dplyr::filter(dat_growth, Species == "TRES", !is.na(meanmintempI), meanmaxtempI < 45, !is.na(meanmintempI)) |>
  mutate(
    across(c(gweight, meanmintempI, meanmintempI, juliandate, brood_size, age),
      ~ scale(.x)[, 1],
      .names = "{.col}_scaled"
    ),
...
(t <- emmeans(g_lintemp_addmin, specs = ~habitat, by = c("meanmintempI_scaled"), at = list(meanmintempI_scaled = c(-2, 0, 2)), type = "response") |> as.tibble() |>
  mutate(
    meanmintempI_scaled = (meanmintempI_scaled * sd(data$meanmintempI)) + mean(data$meanmintempI),
    across(where(is.numeric), ~ round(.x, digits = 2)),
    meanmintempI_scaled = round(meanmintempI_scaled),
...
g_provis_cort <- lmerTest::lmer(gweight ~ cort_s1_scaled + provis_mean_scaled + poly(meanmaxtempI_scaled, 2) + meanh_scaled + age_scaled + condition_scaled + (1 | attempt_id), data = dplyr::filter(dat_growth, Species == "WEBL", !is.na(meanmaxtempI), meanmaxtempI < 45, !is.na(meanmintempI)) |>
  mutate(
    across(c(gweight, meanmaxtempI, meanmintempI, juliandate, brood_size, age, meanh, cort_s1, condition, provis_mean),
      ~ scale(.x)[, 1],
      .names = "{.col}_scaled"
    ),
    meanmaxtempI_scaled_sq = meanmaxtempI_scaled * meanmaxtempI_scaled
...
data <- dplyr::filter(
  dat_growth, Species == "WEBL", !is.na(gweight), !is.na(cort_s1), !is.na(provis_mean), !is.na(meanmaxtempI),
...
g_provis_abscort <- lmerTest::lmer(gweight ~ abs_change_cort_scaled + provis_mean_scaled + meanmaxtempI_scaled + meanmintempI_scaled + meanh_scaled + age_scaled + condition_scaled + (1 | attempt_id), data = dplyr::filter(dat_growth, Species == "WEBL", !is.na(meanmaxtempI), meanmaxtempI < 45, !is.na(meanmintempI)) |>
  mutate(
    across(c(gweight, meanmaxtempI, meanmintempI, juliandate, brood_size, age, meanh, abs_change_cort, condition, provis_mean),
      ~ scale(.x)[, 1],
      .names = "{.col}_scaled"
    ),
    meanmaxtempI_scaled_sq = meanmaxtempI_scaled * meanmaxtempI_scaled
...
data <- dplyr::filter(
  dat_growth, Species == "WEBL", !is.na(gweight), !is.na(abs_change_cort), !is.na(provis_mean), !is.na(meanmaxtempI),
  !is.na(meanmintempI), !is.na(meanh), !is.na(age), !is.na(condition)
) |>
  mutate(
    across(c(gweight, meanmaxtempI, meanmintempI, juliandate, brood_size, age, meanh, cort_s1, condition, provis_mean),
...
(t <- emmeans(g_provis_abscort, specs = ~provis_mean_scaled, by = c("provis_mean_scaled"), at = list(provis_mean_scaled = c(-2, 0, 2)), type = "response") |> as.tibble() |>
  mutate(
    provis_mean_scaled = (provis_mean_scaled * sd(data$provis_mean, na.rm = TRUE)) + mean(data$provis_mean, na.rm = TRUE),
    across(where(is.numeric), ~ round(.x, digits = 2)),
...
provis_trans_webl <- trans_new("provis_trans_webl",
  transform = function(x) {
    (x * sd_provis_webl) + mean_provis_webl
  },
  inverse = function(x) {
    x
  }
...
data <- dplyr::filter(
  dat_growth, Species == "TRES", !is.na(gweight), !is.na(cort_s1), !is.na(provis_mean), !is.na(meanmaxtempI),
  !is.na(meanmintempI), !is.na(meanh), !is.na(age), !is.na(condition)
) |>
  mutate(
    across(c(gweight, meanmaxtempI, meanmintempI, juliandate, brood_size, age, meanh, cort_s1, condition, provis_mean),
...
data <- dplyr::filter(
  dat_growth, Species == "TRES", !is.na(gweight), !is.na(abs_change_cort), !is.na(provis_mean), !is.na(meanmaxtempI),
  !is.na(meanmintempI), !is.na(meanh), !is.na(age), !is.na(condition)
) |>
  mutate(
    across(c(gweight, meanmaxtempI, meanmintempI, juliandate, brood_size, age, meanh, abs_change_cort, condition, provis_mean),
...
(t <- emmeans(g_provis_abscort, specs = ~abs_change_cort_scaled, by = c("abs_change_cort_scaled"), at = list(abs_change_cort_scaled = c(-2, 0, 2)), type = "response") |> as.tibble() |>
  mutate(
    abs_change_cort_scaled = (abs_change_cort_scaled * sd(data$abs_change_cort, na.rm = TRUE)) + mean(data$abs_change_cort, na.rm = TRUE),
    across(where(is.numeric), ~ round(.x, digits = 2)),
...
provis_trans_tres <- trans_new("provis_trans_tres",
  transform = function(x) {
    (x * sd_provis_tres) + mean_provis_tres
  },
  inverse = function(x) {
    x
  }
...
temp_trans_s1_webl <- trans_new("temp_trans_s1_webl",
  transform = function(x) {
    (x * sd_temp_s1_webl) + mean_temp_s1_webl
  },
  inverse = function(x) {
    x
  }
...
(figs2_webl <- ggpredict(s1_lintemp_noint, terms = c("meanmaxtempI_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_webl,
    breaks = c(
      (20 - mean_temp_s1_webl) / sd_temp_s1_webl,
...
temp_trans_s2_webl <- trans_new("temp_trans_s2_webl",
  transform = function(x) {
    (x * sd_temp_s2_webl) + mean_temp_s2_webl
  },
  inverse = function(x) {
    x
  }
...
(fig_webl_s2 <- ggpredict(s2_lintemp, terms = c("meanmaxtempI_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_webl,
    breaks = c(
      (20 - mean_temp_s2_webl) / sd_temp_s2_webl,
...
ss_year_webl_s1_priordayt <- s1_lintemp_addmax@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_s1_priordayt_webl <- trans_new("temp_trans_s1_priordayt_webl",
  transform = function(x) {
    (x * sd_temp_s1_priordayt_webl) + mean_temp_s1_priordayt_webl
  },
  inverse = function(x) {
    x
  }
...
(figs2_priordayt_webl <- ggpredict(s1_lintemp_addmax, terms = c("maxt_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_priordayt_webl,
    breaks = c(
      (20 - mean_temp_s1_priordayt_webl) / sd_temp_s1_priordayt_webl,
...
ss_year_webl_s2_priordayt <- s2_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_s2_priordayt_webl <- trans_new("temp_trans_s2_priordayt_webl",
  transform = function(x) {
    (x * sd_temp_s2_priordayt_webl) + mean_temp_s2_priordayt_webl
  },
  inverse = function(x) {
    x
  }
...
(fig_priordayt_webl_s2 <- ggpredict(s2_lintemp_addmax, terms = c("maxt_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_priordayt_webl,
    breaks = c(
      (20 - mean_temp_s2_priordayt_webl) / sd_temp_s2_priordayt_webl,
...
ss_year_webl_abs_priordayt <- abs_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_webl_priordayt <- trans_new("temp_trans_webl_priordayt",
  transform = function(x) {
    (x * sd_temp_webl_priordayt) + mean_temp_webl_priordayt
  },
  inverse = function(x) {
    x
  }
...
(fig4_webl_priordayt <- ggpredict(abs_lintemp_noint, terms = c("maxt_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "WEBL cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_webl_priordayt,
    breaks = c(
      (20 - mean_temp_webl_priordayt) / sd_temp_webl_priordayt,
...
ss_year_webl_s1_priordaymaxhhi <- s1_lintemp_addmax@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s1_priordaymaxhhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_priordaymaxhhi_webl <- s1_lintemp_addmax@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_priordaymaxhhi_webl <- trans_new("temp_trans_s1_priordaymaxhhi_webl",
  transform = function(x) {
    (x * sd_temp_s1_priordaymaxhhi_webl) + mean_temp_s1_priordaymaxhhi_webl
  },
  inverse = function(x) {
    x
  }
...
(figs2_priordaymaxhhi_webl <- ggpredict(s1_lintemp_addmax, terms = c("maxhi_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_priordaymaxhhi_webl,
    breaks = c(
      (20 - mean_temp_s1_priordaymaxhhi_webl) / sd_temp_s1_priordaymaxhhi_webl,
...
ss_year_webl_s2_priordaymaxhhi <- s2_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s2_priordaymaxhhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_priordaymaxhhi_webl <- s2_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_priordaymaxhhi_webl <- trans_new("temp_trans_s2_priordaymaxhhi_webl",
  transform = function(x) {
    (x * sd_temp_s2_priordaymaxhhi_webl) + mean_temp_s2_priordaymaxhhi_webl
  },
  inverse = function(x) {
    x
  }
...
(fig_priordaymaxhhi_webl_s2 <- ggpredict(s2_lintemp_noint, terms = c("maxhi_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_priordaymaxhhi_webl,
    breaks = c(
      (20 - mean_temp_s2_priordaymaxhhi_webl) / sd_temp_s2_priordaymaxhhi_webl,
...
ss_year_webl_abs_priordaymaxhhi <- abs_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_abs_priordaymaxhhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))
...
temp_trans_webl_priordaymaxhhi <- trans_new("temp_trans_webl_priordaymaxhhi",
  transform = function(x) {
    (x * sd_temp_webl_priordaymaxhhi) + mean_temp_webl_priordaymaxhhi
  },
  inverse = function(x) {
    x
  }
...
(fig4_webl_priordaymaxhhi <- ggpredict(abs_lintemp_noint, terms = c("maxhi_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "WEBL cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_webl_priordaymaxhhi,
    breaks = c(
      (20 - mean_temp_webl_priordaymaxhhi) / sd_temp_webl_priordaymaxhhi,
...
ss_year_webl_s1_weekhi <- s1_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s1_weekhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_weekhi_webl <- s1_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_weekhi_webl <- trans_new("temp_trans_s1_weekhi_webl",
  transform = function(x) {
    (x * sd_temp_s1_weekhi_webl) + mean_temp_s1_weekhi_webl
  },
  inverse = function(x) {
    x
  }
...
(figs2_weekhi_webl <- ggpredict(s1_lintemp_noint, terms = c("maxhi_week_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_weekhi_webl,
    breaks = c(
      (20 - mean_temp_s1_weekhi_webl) / sd_temp_s1_weekhi_webl,
...
ss_year_webl_s2_weekhi <- s2_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s2_weekhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_weekhi_webl <- s2_lintemp@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_weekhi_webl <- trans_new("temp_trans_s2_weekhi_webl",
  transform = function(x) {
    (x * sd_temp_s2_weekhi_webl) + mean_temp_s2_weekhi_webl
  },
  inverse = function(x) {
    x
  }
...
(fig_weekhi_webl_s2 <- ggpredict(s2_lintemp, terms = c("maxhi_week_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_weekhi_webl,
    breaks = c(
      (20 - mean_temp_s2_weekhi_webl) / sd_temp_s2_weekhi_webl,
...
ss_year_webl_abs_weekhi <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_webl_weekhi <- trans_new("temp_trans_webl_weekhi",
  transform = function(x) {
    (x * sd_temp_webl_weekhi) + mean_temp_webl_weekhi
  },
  inverse = function(x) {
    x
  }
...
(fig4_webl_weekhi <- ggpredict(abs_lintemp, terms = c("maxhi_week_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "WEBL cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_webl_weekhi,
    breaks = c(
      (20 - mean_temp_webl_weekhi) / sd_temp_webl_weekhi,
...
ss_year_webl_s1_cumhiday <- s1_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s1_cumhiday |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_cumhiday_webl <- s1_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_cumhiday_webl <- trans_new("temp_trans_s1_cumhiday_webl",
  transform = function(x) {
    (x * sd_temp_s1_cumhiday_webl) + mean_temp_s1_cumhiday_webl
  },
  inverse = function(x) {
    x
  }
...
(figs2_cumhiday_webl <- ggpredict(s1_lintemp_noint, terms = c("hihours_over_30hi_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_cumhiday_webl,
    breaks = c(
      (0 - mean_temp_s1_cumhiday_webl) / sd_temp_s1_cumhiday_webl,
...
ss_year_webl_s2_cumhiday <- s2_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s2_cumhiday |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_cumhiday_webl <- s2_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_cumhiday_webl <- trans_new("temp_trans_s2_cumhiday_webl",
  transform = function(x) {
    (x * sd_temp_s2_cumhiday_webl) + mean_temp_s2_cumhiday_webl
  },
  inverse = function(x) {
    x
  }
...
(fig_cumhiday_webl_s2 <- ggpredict(s2_lintemp_noint, terms = c("hihours_over_30hi_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_cumhiday_webl,
    breaks = c(
      (0 - mean_temp_s2_cumhiday_webl) / sd_temp_s2_cumhiday_webl,
...
ss_year_webl_abs_cumhiday <- abs_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_webl_cumhiday <- trans_new("temp_trans_webl_cumhiday",
  transform = function(x) {
    (x * sd_temp_webl_cumhiday) + mean_temp_webl_cumhiday
  },
  inverse = function(x) {
    x
  }
...
(fig4_webl_cumhiday <- ggpredict(abs_lintemp_noint, terms = c("hihours_over_30hi_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "WEBL cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_webl_cumhiday,
    breaks = c(
      (0 - mean_temp_webl_cumhiday) / sd_temp_webl_cumhiday,
...
ss_year_webl_s1_cumhiweek <- s1_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s1_cumhiweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_cumhiweek_webl <- s1_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_cumhiweek_webl <- trans_new("temp_trans_s1_cumhiweek_webl",
  transform = function(x) {
    (x * sd_temp_s1_cumhiweek_webl) + mean_temp_s1_cumhiweek_webl
  },
  inverse = function(x) {
    x
  }
...
(figs2_cumhiweek_webl <- ggpredict(s1_lintemp_noint, terms = c("hihours_over_30hi_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_cumhiweek_webl,
    breaks = c(
      (0 - mean_temp_s1_cumhiweek_webl) / sd_temp_s1_cumhiweek_webl,
...
ss_year_webl_s2_cumhiweek <- s2_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s2_cumhiweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_cumhiweek_webl <- s2_lintemp@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_cumhiweek_webl <- trans_new("temp_trans_s2_cumhiweek_webl",
  transform = function(x) {
    (x * sd_temp_s2_cumhiweek_webl) + mean_temp_s2_cumhiweek_webl
  },
  inverse = function(x) {
    x
  }
...
(fig_cumhiweek_webl_s2 <- ggpredict(s2_lintemp, terms = c("hihours_over_30hi_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_cumhiweek_webl,
    breaks = c(
      (0 - mean_temp_s2_cumhiweek_webl) / sd_temp_s2_cumhiweek_webl,
...
ss_year_webl_abs_cumhiweek <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_abs_trans_webl_cumhiweek <- trans_new("temp_trans_webl_cumhiweek",
  transform = function(x) {
    (x * sd_abs_temp_webl_cumhiweek) + mean_abs_temp_webl_cumhiweek
  },
  inverse = function(x) {
    x
  }
...
(fig4_webl_cumhiweek <- ggpredict(abs_lintemp, terms = c("hihours_over_30hi_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "WEBL cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_abs_trans_webl_cumhiweek,
    breaks = c(
      (0 - mean_abs_temp_webl_cumhiweek) / sd_abs_temp_webl_cumhiweek,
...
ss_year_webl_s1_cumdegreeday <- s1_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s1_cumdegreeday |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_cumdegreeday_webl <- s1_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_cumdegreeday_webl <- trans_new("temp_trans_s1_cumdegreeday_webl",
  transform = function(x) {
    (x * sd_temp_s1_cumdegreeday_webl) + mean_temp_s1_cumdegreeday_webl
  },
  inverse = function(x) {
    x
  }
...
(figs2_cumdegreeday_webl <- ggpredict(s1_lintemp_noint, terms = c("degreehours_over_30C_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_cumdegreeday_webl,
    breaks = c(
      (0 - mean_temp_s1_cumdegreeday_webl) / sd_temp_s1_cumdegreeday_webl,
...
ss_year_webl_s2_cumdegreeday <- s2_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s2_cumdegreeday |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_cumdegreeday_webl <- s2_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_cumdegreeday_webl <- trans_new("temp_trans_s2_cumdegreeday_webl",
  transform = function(x) {
    (x * sd_temp_s2_cumdegreeday_webl) + mean_temp_s2_cumdegreeday_webl
  },
  inverse = function(x) {
    x
  }
...
(fig_cumdegreeday_webl_s2 <- ggpredict(s2_lintemp_noint, terms = c("degreehours_over_30C_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_cumdegreeday_webl,
    breaks = c(
      (0 - mean_temp_s2_cumdegreeday_webl) / sd_temp_s2_cumdegreeday_webl,
...
ss_year_webl_abs_cumdegreeday <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_webl_cumdegreeday <- trans_new("temp_trans_webl_cumdegreeday",
  transform = function(x) {
    (x * sd_temp_webl_cumdegreeday) + mean_temp_webl_cumdegreeday
  },
  inverse = function(x) {
    x
  }
...
(fig4_webl_cumdegreeday <- ggpredict(abs_lintemp, terms = c("degreehours_over_30C_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "WEBL cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_webl_cumdegreeday,
    breaks = c(
      (0 - mean_temp_webl_cumdegreeday) / sd_temp_webl_cumdegreeday,
...
ss_year_webl_s1_cumdegreeweek <- s1_lintemp_addmin@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s1_cumdegreeweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_cumdegreeweek_webl <- s1_lintemp_addmin@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_cumdegreeweek_webl <- trans_new("temp_trans_s1_cumdegreeweek_webl",
  transform = function(x) {
    (x * sd_temp_s1_cumdegreeweek_webl) + mean_temp_s1_cumdegreeweek_webl
  },
  inverse = function(x) {
    x
  }
...
(figs2_cumdegreeweek_webl <- ggpredict(s1_lintemp_addmin, terms = c("degreehours_over_30C_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_cumdegreeweek_webl,
    breaks = c(
      (0 - mean_temp_s1_cumdegreeweek_webl) / sd_temp_s1_cumdegreeweek_webl,
...
ss_year_webl_s2_cumdegreeweek <- s2_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_s2_cumdegreeweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_cumdegreeweek_webl <- s2_lintemp@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_cumdegreeweek_webl <- trans_new("temp_trans_s2_cumdegreeweek_webl",
  transform = function(x) {
    (x * sd_temp_s2_cumdegreeweek_webl) + mean_temp_s2_cumdegreeweek_webl
  },
  inverse = function(x) {
    x
  }
...
(fig_cumdegreeweek_webl_s2 <- ggpredict(s2_lintemp, terms = c("degreehours_over_30C_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_cumdegreeweek_webl,
    breaks = c(
      (0 - mean_temp_s2_cumdegreeweek_webl) / sd_temp_s2_cumdegreeweek_webl,
...
ss_year_webl_abs_cumdegreeweek <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_webl_abs_cumdegreeweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))
...
temp_trans_webl_cumdegreeweek <- trans_new("temp_trans_webl_cumdegreeweek",
  transform = function(x) {
    (x * sd_temp_webl_cumdegreeweek) + mean_temp_webl_cumdegreeweek
  },
  inverse = function(x) {
    x
  }
...
(fig4_webl_cumdegreeweek <- ggpredict(abs_lintemp, terms = c("degreehours_over_30C_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "WEBL cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_webl_cumdegreeweek,
    breaks = c(
      (0 - mean_temp_webl_cumdegreeweek) / sd_temp_webl_cumdegreeweek,
...
temp_trans_s1_tres <- trans_new("temp_trans_s1_tres",
  transform = function(x) {
    (x * sd_temp_s1_tres) + mean_temp_s1_tres
  },
  inverse = function(x) {
    x
  }
...
(figs2_tres <- ggpredict(s1_lintemp_addmax, terms = c("meanmaxtempI_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_tres,
    breaks = c(
      (20 - mean_temp_s1_tres) / sd_temp_s1_tres,
...
temp_trans_s2_tres <- trans_new("temp_trans_s2_tres",
  transform = function(x) {
    (x * sd_temp_s2_tres) + mean_temp_s2_tres
  },
  inverse = function(x) {
    x
  }
...
(fig_tres_s2 <- ggpredict(s2_lintemp_addmin, terms = c("meanmaxtempI_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_tres,
    breaks = c(
      (20 - mean_temp_s2_tres) / sd_temp_s2_tres,
...
ss_year_tres_s1_priordayt <- s1_lintemp_addmin@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_s1_priordayt_tres <- trans_new("temp_trans_s1_priordayt_tres",
  transform = function(x) {
    (x * sd_temp_s1_priordayt_tres) + mean_temp_s1_priordayt_tres
  },
  inverse = function(x) {
    x
  }
...
(figs2_priordayt_tres <- ggpredict(s1_lintemp_addmin, terms = c("maxt_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_priordayt_tres,
    breaks = c(
      (25 - mean_temp_s1_priordayt_tres) / sd_temp_s1_priordayt_tres,
...
ss_year_tres_s2_priordayt <- s2_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_s2_priordayt_tres <- trans_new("temp_trans_s2_priordayt_tres",
  transform = function(x) {
    (x * sd_temp_s2_priordayt_tres) + mean_temp_s2_priordayt_tres
  },
  inverse = function(x) {
    x
  }
...
(fig_priordayt_tres_s2 <- ggpredict(s2_lintemp, terms = c("maxt_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_priordayt_tres,
    breaks = c(
      (25 - mean_temp_s2_priordayt_tres) / sd_temp_s2_priordayt_tres,
...
ss_year_tres_abs_priordayt <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_tres_priordayt <- trans_new("temp_trans_tres_priordayt",
  transform = function(x) {
    (x * sd_temp_tres_priordayt) + mean_temp_tres_priordayt
  },
  inverse = function(x) {
    x
  }
...
(fig4_tres_priordayt <- ggpredict(abs_lintemp, terms = c("maxt_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "TRES cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_tres_priordayt,
    breaks = c(
      (20 - mean_temp_tres_priordayt) / sd_temp_tres_priordayt,
...
ss_year_tres_s1_priordaymaxhhi <- s1_lintemp_addmax@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s1_priordaymaxhhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_priordaymaxhhi_tres <- s1_lintemp_addmax@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_priordaymaxhhi_tres <- trans_new("temp_trans_s1_priordaymaxhhi_tres",
  transform = function(x) {
    (x * sd_temp_s1_priordaymaxhhi_tres) + mean_temp_s1_priordaymaxhhi_tres
  },
  inverse = function(x) {
    x
  }
...
(figs2_priordaymaxhhi_tres <- ggpredict(s1_lintemp_addmax, terms = c("maxhi_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_priordaymaxhhi_tres,
    breaks = c(
      (20 - mean_temp_s1_priordaymaxhhi_tres) / sd_temp_s1_priordaymaxhhi_tres,
...
ss_year_tres_s2_priordaymaxhhi <- s2_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s2_priordaymaxhhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_priordaymaxhhi_tres <- s2_lintemp@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_priordaymaxhhi_tres <- trans_new("temp_trans_s2_priordaymaxhhi_tres",
  transform = function(x) {
    (x * sd_temp_s2_priordaymaxhhi_tres) + mean_temp_s2_priordaymaxhhi_tres
  },
  inverse = function(x) {
    x
  }
...
(fig_priordaymaxhhi_tres_s2 <- ggpredict(s2_lintemp, terms = c("maxhi_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_priordaymaxhhi_tres,
    breaks = c(
      (20 - mean_temp_s2_priordaymaxhhi_tres) / sd_temp_s2_priordaymaxhhi_tres,
...
ss_year_tres_abs_priordaymaxhhi <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_abs_priordaymaxhhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))
...
temp_trans_tres_priordaymaxhhi <- trans_new("temp_trans_tres_priordaymaxhhi",
  transform = function(x) {
    (x * sd_temp_tres_priordaymaxhhi) + mean_temp_tres_priordaymaxhhi
  },
  inverse = function(x) {
    x
  }
...
(fig4_tres_priordaymaxhhi <- ggpredict(abs_lintemp, terms = c("maxhi_prior_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "TRES cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_tres_priordaymaxhhi,
    breaks = c(
      (20 - mean_temp_tres_priordaymaxhhi) / sd_temp_tres_priordaymaxhhi,
...
ss_year_tres_s1_weekhi <- s1_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s1_weekhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_weekhi_tres <- s1_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_weekhi_tres <- trans_new("temp_trans_s1_weekhi_tres",
  transform = function(x) {
    (x * sd_temp_s1_weekhi_tres) + mean_temp_s1_weekhi_tres
  },
  inverse = function(x) {
    x
  }
...
(figs2_weekhi_tres <- ggpredict(s1_lintemp_noint, terms = c("maxhi_week_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_weekhi_tres,
    breaks = c(
      (20 - mean_temp_s1_weekhi_tres) / sd_temp_s1_weekhi_tres,
...
ss_year_tres_s2_weekhi <- s2_lintemp_addmin@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s2_weekhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_weekhi_tres <- s2_lintemp_addmin@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_weekhi_tres <- trans_new("temp_trans_s2_weekhi_tres",
  transform = function(x) {
    (x * sd_temp_s2_weekhi_tres) + mean_temp_s2_weekhi_tres
  },
  inverse = function(x) {
    x
  }
...
(fig_weekhi_tres_s2 <- ggpredict(s2_lintemp_addmin, terms = c("maxhi_week_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_weekhi_tres,
    breaks = c(
      (20 - mean_temp_s2_weekhi_tres) / sd_temp_s2_weekhi_tres,
...
ss_year_tres_abs_weekhi <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_tres_weekhi <- trans_new("temp_trans_tres_weekhi",
  transform = function(x) {
    (x * sd_temp_tres_weekhi) + mean_temp_tres_weekhi
  },
  inverse = function(x) {
    x
  }
...
(fig4_tres_weekhi <- ggpredict(abs_lintemp, terms = c("maxhi_week_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "TRES cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_tres_weekhi,
    breaks = c(
      (30 - mean_temp_tres_weekhi) / sd_temp_tres_weekhi,
...
ss_year_tres_s1_cumhiday <- s1_lintemp_addmax@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s1_cumhiday |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_cumhiday_tres <- s1_lintemp_addmax@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_cumhiday_tres <- trans_new("temp_trans_s1_cumhiday_tres",
  transform = function(x) {
    (x * sd_temp_s1_cumhiday_tres) + mean_temp_s1_cumhiday_tres
  },
  inverse = function(x) {
    x
  }
...
(figs2_cumhiday_tres <- ggpredict(s1_lintemp_addmax, terms = c("hihours_over_30hi_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_cumhiday_tres,
    breaks = c(
      (0 - mean_temp_s1_cumhiday_tres) / sd_temp_s1_cumhiday_tres,
...
ss_year_tres_s2_cumhiday <- s2_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s2_cumhiday |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_cumhiday_tres <- s2_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_cumhiday_tres <- trans_new("temp_trans_s2_cumhiday_tres",
  transform = function(x) {
    (x * sd_temp_s2_cumhiday_tres) + mean_temp_s2_cumhiday_tres
  },
  inverse = function(x) {
    x
  }
...
(fig_cumhiday_tres_s2 <- ggpredict(s2_lintemp_noint, terms = c("hihours_over_30hi_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_cumhiday_tres,
    breaks = c(
      (0 - mean_temp_s2_cumhiday_tres) / sd_temp_s2_cumhiday_tres,
...
ss_year_tres_abs_cumhiday <- abs_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_tres_cumhiday <- trans_new("temp_trans_tres_cumhiday",
  transform = function(x) {
    (x * sd_temp_tres_cumhiday) + mean_temp_tres_cumhiday
  },
  inverse = function(x) {
    x
  }
...
(fig4_tres_cumhiday <- ggpredict(abs_lintemp_noint, terms = c("hihours_over_30hi_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "TRES cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_tres_cumhiday,
    breaks = c(
      (0 - mean_temp_tres_cumhiday) / sd_temp_tres_cumhiday,
...
ss_year_tres_s1_cumhiweek <- s1_lintemp_addmax@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s1_cumhiweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_cumhiweek_tres <- s1_lintemp_addmax@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_cumhiweek_tres <- trans_new("temp_trans_s1_cumhiweek_tres",
  transform = function(x) {
    (x * sd_temp_s1_cumhiweek_tres) + mean_temp_s1_cumhiweek_tres
  },
  inverse = function(x) {
    x
  }
...
(figs2_cumhiweek_tres <- ggpredict(s1_lintemp_addmax, terms = c("hihours_over_30hi_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_cumhiweek_tres,
    breaks = c(
      (0 - mean_temp_s1_cumhiweek_tres) / sd_temp_s1_cumhiweek_tres,
...
ss_year_tres_s2_cumhiweek <- s2_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s2_cumhiweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_cumhiweek_tres <- s2_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_cumhiweek_tres <- trans_new("temp_trans_s2_cumhiweek_tres",
  transform = function(x) {
    (x * sd_temp_s2_cumhiweek_tres) + mean_temp_s2_cumhiweek_tres
  },
  inverse = function(x) {
    x
  }
...
(fig_cumhiweek_tres_s2 <- ggpredict(s2_lintemp_noint, terms = c("hihours_over_30hi_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_cumhiweek_tres,
    breaks = c(
      (0 - mean_temp_s2_cumhiweek_tres) / sd_temp_s2_cumhiweek_tres,
...
ss_year_tres_abs_cumhiweek <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_abs_trans_tres_cumhiweek <- trans_new("temp_trans_tres_cumhiweek",
  transform = function(x) {
    (x * sd_abs_temp_tres_cumhiweek) + mean_abs_temp_tres_cumhiweek
  },
  inverse = function(x) {
    x
  }
...
(fig4_tres_cumhiweek <- ggpredict(abs_lintemp, terms = c("hihours_over_30hi_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "TRES cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_abs_trans_tres_cumhiweek,
    breaks = c(
      (0 - mean_abs_temp_tres_cumhiweek) / sd_abs_temp_tres_cumhiweek,
...
ss_year_tres_s1_cumdegreeday <- s1_lintemp_addmax@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s1_cumdegreeday |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_cumdegreeday_tres <- s1_lintemp_addmax@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_cumdegreeday_tres <- trans_new("temp_trans_s1_cumdegreeday_tres",
  transform = function(x) {
    (x * sd_temp_s1_cumdegreeday_tres) + mean_temp_s1_cumdegreeday_tres
  },
  inverse = function(x) {
    x
  }
...
(figs2_cumdegreeday_tres <- ggpredict(s1_lintemp_addmax, terms = c("degreehours_over_30C_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_cumdegreeday_tres,
    breaks = c(
      (0 - mean_temp_s1_cumdegreeday_tres) / sd_temp_s1_cumdegreeday_tres,
...
ss_year_tres_s2_cumdegreeday <- s2_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s2_cumdegreeday |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_cumdegreeday_tres <- s2_lintemp@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_cumdegreeday_tres <- trans_new("temp_trans_s2_cumdegreeday_tres",
  transform = function(x) {
    (x * sd_temp_s2_cumdegreeday_tres) + mean_temp_s2_cumdegreeday_tres
  },
  inverse = function(x) {
    x
  }
...
(fig_cumdegreeday_tres_s2 <- ggpredict(s2_lintemp, terms = c("degreehours_over_30C_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_cumdegreeday_tres,
    breaks = c(
      (0 - mean_temp_s2_cumdegreeday_tres) / sd_temp_s2_cumdegreeday_tres,
...
ss_year_tres_abs_cumdegreeday <- abs_lintemp@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
temp_trans_tres_cumdegreeday <- trans_new("temp_trans_tres_cumdegreeday",
  transform = function(x) {
    (x * sd_temp_tres_cumdegreeday) + mean_temp_tres_cumdegreeday
  },
  inverse = function(x) {
    x
  }
...
(fig4_tres_cumdegreeday <- ggpredict(abs_lintemp, terms = c("degreehours_over_30C_priorday_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "TRES cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_tres_cumdegreeday,
    breaks = c(
      (0 - mean_temp_tres_cumdegreeday) / sd_temp_tres_cumdegreeday,
...
ss_year_tres_s1_cumdegreeweek <- s1_lintemp_addmax@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s1_cumdegreeweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s1_cumdegreeweek_tres <- s1_lintemp_addmax@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s1_cumdegreeweek_tres <- trans_new("temp_trans_s1_cumdegreeweek_tres",
  transform = function(x) {
    (x * sd_temp_s1_cumdegreeweek_tres) + mean_temp_s1_cumdegreeweek_tres
  },
  inverse = function(x) {
    x
  }
...
(figs2_cumdegreeweek_tres <- ggpredict(s1_lintemp_addmax, terms = c("degreehours_over_30C_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s1_cumdegreeweek_tres,
    breaks = c(
      (0 - mean_temp_s1_cumdegreeweek_tres) / sd_temp_s1_cumdegreeweek_tres,
...
ss_year_tres_s2_cumdegreeweek <- s2_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_s2_cumdegreeweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))

samp_s2_cumdegreeweek_tres <- s2_lintemp_noint@frame |>
  group_by(habitat) |>
  summarize(count = n())
...
temp_trans_s2_cumdegreeweek_tres <- trans_new("temp_trans_s2_cumdegreeweek_tres",
  transform = function(x) {
    (x * sd_temp_s2_cumdegreeweek_tres) + mean_temp_s2_cumdegreeweek_tres
  },
  inverse = function(x) {
    x
  }
...
(fig_cumdegreeweek_tres_s2 <- ggpredict(s2_lintemp_noint, terms = c("degreehours_over_30C_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = element_blank()) +
  scale_x_continuous(
    trans = temp_trans_s2_cumdegreeweek_tres,
    breaks = c(
      (0 - mean_temp_s2_cumdegreeweek_tres) / sd_temp_s2_cumdegreeweek_tres,
...
ss_year_tres_abs_cumdegreeweek <- abs_lintemp_noint@frame |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
  ...
  ungroup() |>
  mutate(Total = `2022` + `2023`)
ss_year_tres_abs_cumdegreeweek |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))
...
temp_trans_tres_cumdegreeweek <- trans_new("temp_trans_tres_cumdegreeweek",
  transform = function(x) {
    (x * sd_temp_tres_cumdegreeweek) + mean_temp_tres_cumdegreeweek
  },
  inverse = function(x) {
    x
  }
...
(fig4_tres_cumdegreeweek <- ggpredict(abs_lintemp_noint, terms = c("degreehours_over_30C_priorweek_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  labs(title = "TRES cort; max temp * habitat interaction") +
  scale_x_continuous(
    trans = temp_trans_tres_cumdegreeweek,
    breaks = c(
      (0 - mean_temp_tres_cumdegreeweek) / sd_temp_tres_cumdegreeweek,
...
ss_year_survival_webl <- data_webl |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
samp_tres <- s_nestpd_TRES_noint$data |>
  group_by(habitat) |>
  summarize(count = n())
ss_year_survival_tres <- s_nestpd_TRES_noint$data |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
samp_webl <- data_webl |>
  group_by(habitat) |>
  summarize(count = n())
ss_year_survival_webl_meanmaxhi <- data_webl |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
ss_year_survival_webl_meanmaxhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))
...
samp_webl <- data_webl |>
  group_by(habitat) |>
  summarize(count = n())
ss_year_survival_webl_deghr_30 <- data_webl |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
ss_year_survival_webl_deghr_30 |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))
...
samp_webl <- data_webl |>
  group_by(habitat) |>
  summarize(count = n())
ss_year_survival_webl_hihr_30 <- data_webl |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
samp_tres <- data_tres |>
  group_by(habitat) |>
  summarize(count = n())
ss_year_survival_tres_meanmaxhi <- data_tres |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
ss_year_survival_tres_meanmaxhi |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))
...
samp_tres <- data_tres |>
  group_by(habitat) |>
  summarize(count = n())
ss_year_survival_tres_deghr_30 <- data_tres |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
ss_year_survival_tres_deghr_30 |>
  gt() |>
  grand_summary_rows(columns = -c(Habitat), fns = list(id = "Total") ~ sum(.))
...
samp_tres <- data_tres |>
  group_by(habitat) |>
  summarize(count = n())
ss_year_survival_tres_hihr_30 <- data_tres |>
  group_by(habitat, year_fct) |>
  summarize(count = n()) |>
  pivot_wider(values_from = count, names_from = year_fct) |>
  as.tibble() |>
...
dat_provis |>
  dplyr::select(c(species, attempt_id)) |>
  distinct() |>
  summarize(.by = species, n = n())
...
c <- anova(m, m_linint, m_noint) |>
  tibble() |>
  mutate(Model = c("No temp * LC interaction", "linear temp * LC interaction", "quadratic temp * LC  interaction"), .before = Df)
...
c <- anova(m, m_linint, m_noint) |>
  tibble() |>
  mutate(Model = c("No temp * LC interaction", "Linear temp * LC interaction", "Squared temp * LC interaction"), .before = Df)
...
ss_year_tres_provis <- m$frame |>
  ...
  ungroup() |>
  mutate(
    `2021` = replace_na(`2021`, list(count_ind = 0, count_attempt = 0)),
...
(int_tab_provis_webl_hi <- c |>
  ...
  mutate(across(c(AIC, Chisq), ~ round(.x, digits = 2)),
    instant_temp = if_else(instant_temp < 0.001, "<0.001", as.character(instant_temp))
  ) |> gt())
...
hi_30min_trans_webl <- trans_new("hi_30min_trans_webl",
  transform = function(x) {
    (x * sd_hi_30min_webl) + mean_hi_30min_webl
  },
  inverse = function(x) {
    x
  }
...
(fig5_webl_hi <- predict_response(m, terms = c("hi_30min_scaled [all]", "habitat"), bias_correction = TRUE) |>
  ...
  scale_x_continuous(
    trans = hi_30min_trans_webl,
    breaks = c(
      (20 - mean_hi_30min_webl) / sd_hi_30min_webl,
...
hi_30min_trans_tres <- trans_new("hi_30min_trans_tres",
  transform = function(x) {
    (x * sd_hi_30min_tres) + mean_hi_30min_tres
  },
  inverse = function(x) {
    x
  }
...
(p_full <- ggarrange(
  fig5_webl_hi + ylim(0, 55.9) + labs(title = element_blank()) + theme(
    text = element_text(size = 12),
    axis.title.x = element_blank()
  ), fig5_tres_hi + labs(title = element_blank()) + ylim(0, 55.9) + theme(
    text = element_text(size = 12), axis.ticks.y = element_blank(),
    axis.text.y = element_blank(),
    axis.title.y = element_blank(),
    axis.title.x = element_text(hjust = -.8)
...
weblgrowthtrendmax_prior <- emtrends(prior_model, specs = ~habitat, var = c("meanmaxtempI_scaled")) |>
  test() |>
  mutate(across(where(is.numeric), ~ round(.x, digits = 3)),
    df = round(df),
    p.value = if_else(p.value == 0.000, "<0.001", as.character(p.value))
...
weblgrowthtrendmax <- emtrends(g_lintemp, specs = ~habitat, var = c("meanmaxtempI_scaled")) |>
  test() |>
  mutate(across(where(is.numeric), ~ round(.x, digits = 3)),
    df = round(df),
    p.value = if_else(p.value == 0.000, "<0.001", as.character(p.value))
...
tresgrowthtrendmax_prior <- emtrends(prior_model, specs = ~habitat, var = c("meanmaxtempI_scaled")) |>
  test() |>
  mutate(across(where(is.numeric), ~ round(.x, digits = 3)),
    df = round(df),
    p.value = if_else(p.value == 0.000, "<0.001", as.character(p.value))
...
tresgrowthtrendmax <- emtrends(g_lintemp_addmin, specs = ~habitat, var = c("meanmaxtempI_scaled")) |>
  test() |>
  mutate(across(where(is.numeric), ~ round(.x, digits = 3)),
    df = round(df),
    p.value = if_else(p.value == 0.000, "<0.001", as.character(p.value))
...
growth <- rbind(
  weblgrowthtrendmax_prior$`_data`, tresgrowthtrendmax_prior$`_data`,
  weblgrowthtrendmax$`_data`, tresgrowthtrendmax$`_data`
) |>
  rename(Trend = "Max temp trend", `Statistic` = "T-ratio", `P-value` = "P") |>
  mutate(
    Species = rep(c(rep("Western Bluebird", 4), rep("Tree Swallow", 4)), 2),
    Response = "Growth ~ Mean max temperature over prior week",
    Model = c(
      rep("No maximum temperature * day of year interaction", 8),
...
survival <- rbind(
  weblsurvival_nestpd_trendmax_prior$`_data`, tressurvival_nestpd_trendmax_prior$`_data`,
...
s1_priorday <- rbind(
  webls1_priordayt_trendmax_prior$`_data`, tress1_priordayt_trendmax_prior$`_data`,
...
s1_priorweek <- rbind(
  webls1trendmax_prior$`_data`, tress1trendmax_prior$`_data`,
...
abs_priorday <- rbind(
  weblabs_priordayt_trendmax_prior$`_data`, tresabs_priordayt_trendmax_prior$`_data`,
...
abs_priorweek <- rbind(
  weblabstrendmax_prior$`_data`, tresabstrendmax_prior$`_data`,
...
s2_priorday <- rbind(
  webls2_priordayt_trendmax_prior$`_data`, tress2_priordayt_trendmax_prior$`_data`,
...
s2_priorweek <- rbind(
  webls2trendmax_prior$`_data`, tress2trendmax_prior$`_data`,
...
provis <- rbind(
  weblprovistrend_prior$`_data` |> mutate(degree = "linear"), tresprovistrend_prior$`_data`,
