## Create all objects needed for growth analysis
...
# b <- read_csv("data/banding-and-morphometrics_proofed.csv")  # unused; data pre-computed in growth_cort_provis_manytempmeasures.rds
